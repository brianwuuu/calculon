...
def analyzeIterTime():
    ...
    for workload, mem, datatype, per_pic_bw_GBps, mem_add_lat_ns, net_lat_ns in util.cartesian_product(
        [workloads, mems, datatypes, per_pic_bws_GBps, mem_add_lats_ns, net_lats_ns]):
        for max_batch_size in max_batch_sizes:
            args = dict(workload=workload, gpu=gpu, mem=mem,
